...
| groupby.distinct                      | [true,false]            | If you would like the last value in your groupby to rolled up into a simple count of distinct / total. Also includes union/intersection information.                                                                                                                                        |
...
| groupby.stats.percentiles             | [10,20,...]             | The list of percentiles you want to generate when running stats. This will use QDigest to generate aproximate quantile breakdowns by the specified stat field.                                                                                                                              |
