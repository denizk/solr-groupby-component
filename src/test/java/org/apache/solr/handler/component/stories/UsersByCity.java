 ...
 *
 */
public class UsersByCity extends SolrTestCaseJ4 {
    ...
    @Test
    public void should_be_able_to_get_distinct_users_by_city() throws Exception {
        ...
        p.set("rows", "0");
        p.set("indent", "true");
        p.set(GroupByComponent.Params.GROUPBY, "city,user_id");
